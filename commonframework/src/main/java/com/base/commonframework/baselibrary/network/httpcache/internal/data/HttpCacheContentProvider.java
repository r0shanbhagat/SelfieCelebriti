...
public class HttpCacheContentProvider extends ContentProvider {
    ...
    private HttpCacheDbOpenHelper databaseHelper;
    ...
    public boolean onCreate() {
        databaseHelper = new HttpCacheDbOpenHelper(getContext());
        return true;
    }
