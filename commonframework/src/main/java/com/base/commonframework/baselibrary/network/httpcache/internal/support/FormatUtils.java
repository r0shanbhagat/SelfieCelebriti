...
public class FormatUtils {
    ...
    public static String getShareText(Context context, HttpTransaction transaction) {
        String text = "";
        text += context.getString(R.string.httpCacheUrl) + ": " + v(transaction.getUrl()) + "\n";
        text += context.getString(R.string.httpCacheMethod) + ": " + v(transaction.getMethod()) + "\n";
        text += context.getString(R.string.httpCacheProtocol) + ": " + v(transaction.getProtocol()) + "\n";
        text += context.getString(R.string.httpCacheStatus) + ": " + v(transaction.getStatus().toString()) + "\n";
        text += context.getString(R.string.httpCacheResponse) + ": " + v(transaction.getResponseSummaryText()) + "\n";
        text += context.getString(R.string.httpCacheSSL) + ": " + v(context.getString(transaction.isSsl() ? R.string.httpCacheYes : R.string.httpCacheNo)) + "\n";
        text += "\n";
        text += context.getString(R.string.httpCacheRequestTime) + ": " + v(transaction.getRequestDateString()) + "\n";
        text += context.getString(R.string.httpCacheResponseTime) + ": " + v(transaction.getResponseDateString()) + "\n";
        text += context.getString(R.string.httpCacheDuration) + ": " + v(transaction.getDurationString()) + "\n";
        text += "\n";
        text += context.getString(R.string.httpCacheRequestSize) + ": " + v(transaction.getRequestSizeString()) + "\n";
        text += context.getString(R.string.httpCacheResponseSize) + ": " + v(transaction.getResponseSizeString()) + "\n";
        text += context.getString(R.string.httpCacheTotalSize) + ": " + v(transaction.getTotalSizeString()) + "\n";
        text += "\n";
        text += "---------- " + context.getString(R.string.httpCacheRequest) + " ----------\n\n";
        ...
        text += (transaction.requestBodyIsPlainText()) ? v(transaction.getFormattedRequestBody()) :
                context.getString(R.string.httpCacheBodyOmitted);
        text += "\n\n";
        text += "---------- " + context.getString(R.string.httpCacheResponse) + " ----------\n\n";
