...
class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.ViewHolder> {
    ...
    TransactionAdapter(Context context, TransactionListFragment.OnListFragmentInteractionListener listener) {
        ...
        colorDefault = ContextCompat.getColor(context, R.color.httpCacheStatusDefault);
        colorRequested = ContextCompat.getColor(context, R.color.httpCacheStatusRequested);
        colorError = ContextCompat.getColor(context, R.color.httpCacheStatusError);
        color500 = ContextCompat.getColor(context, R.color.httpCacheStatus500);
        color400 = ContextCompat.getColor(context, R.color.httpCacheStatus400);
        color300 = ContextCompat.getColor(context, R.color.httpCacheStatus300);
        ...
        cursorAdapter = new CursorAdapter(TransactionAdapter.this.context, null, CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER) {
            ...
            public View newView(Context context, Cursor cursor, ViewGroup parent) {
                View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.httpcache_list_item_transaction, parent, false);
