...
public class TransactionOverviewFragment extends Fragment implements TransactionFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.httpcache_fragment_transaction_overview, container, false);
    ...
    private void populateUI() {
        if (isAdded() && transaction != null) {
            ...
            ssl.setText((transaction.isSsl() ? R.string.httpCacheYes : R.string.httpCacheNo));
