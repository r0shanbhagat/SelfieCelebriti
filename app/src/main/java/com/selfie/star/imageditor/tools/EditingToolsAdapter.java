package com.selfie.star.imageditor.tools;
...
public class EditingToolsAdapter extends RecyclerView.Adapter<EditingToolsAdapter.ViewHolder> {
    ...
    public EditingToolsAdapter(OnItemSelected onItemSelected) {
        ...
        mToolList.add(new ToolModel("Add Star", R.drawable.ic_actor, ToolType.ADDSTAR));
        mToolList.add(new ToolModel("Add Photo", R.drawable.ic_add_photo, ToolType.ADDPHOTO));
        ...
        mToolList.add(new ToolModel("Sticker", R.drawable.ic_pages_black_24dp, ToolType.STICKER));
    }
